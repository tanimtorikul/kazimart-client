  ...
  return (
    <div className="flex items-center gap-8 md:gap-24 p-2 md:p-4 border border-gray-200 shadow-lg rounded-xl">
      ...
      <div className="flex items-center gap-4 ">
        ...
        <button className="flex items-center justify-center w-8 h-8 text-red-500 text-xl rounded-full hover:bg-gray-600 hover:text-white transition duration-200">
          <FaRegTrashCan />
        </button>
      </div>
