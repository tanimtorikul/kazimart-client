          ...
          {reviews.length > 0 ? (
            <div className="space-y-4">
              {reviews.map((review, index) => (
                <div key={index} className="p-4 rounded-lg flex items-center gap-4">
                  {review.userImage && (
                    <img
                  ...
                  <div>
                    <p className="font-semibold text-[#2B59A4]">{review.userName}</p>
        ...
        <div className="flex-1 mb-6">
          {user ? (
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 bg-white p-4">
              <div>
                <label htmlFor="name" className="inline-block mb-2 text-sm font-medium">
                  Name
                </label>
                <input
                  id="name"
              ...
              <div>
                <label htmlFor="reviewText" className="block mb-2 text-sm font-medium">
                  Your Review
                </label>
                <textarea
                  id="reviewText"
