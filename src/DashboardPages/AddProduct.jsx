...
const AddProduct = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h2 className="text-2xl md:text-3xl font-semibold text-center">Add New Product</h2>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-12">
          {/* Product Name */}
          <div>
            <label htmlFor="name" className="block text-lg md:text-xl font-medium">
              Product Name
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="category" className="block text-lg md:text-xl font-medium">
              Category
            </label>
            <select
          ...
          {/* Product Price */}
          <div>
            <label htmlFor="price" className="block text-lg md:text-xl font-medium">
              Product Price
            </label>
            <input
              type="number"
          ...
          {/* Quantity */}
          <div>
            <label htmlFor="quantity" className="block text-lg md:text-xl font-medium">
              Quantity
            </label>
            <input
              type="text"
          ...
          {/* Product Description */}
          <div>
            <label htmlFor="description" className="block text-lg md:text-xl font-medium">
              Product Description
            </label>
            <textarea
          ...
          {/* Popular Checkbox */}
          <div>
            <label htmlFor="popular" className="block text-lg md:text-xl font-medium">
              Popular
            </label>
            <input
              type="checkbox"
          ...
          <div>
            <label className="block text-lg md:text-xl font-medium">Stock Status</label>
            <div>
              <input
                type="radio"
                id="inStock"
          ...
          <div className="w-full md:w-1/2 mx-auto">
            <label htmlFor="image" className="block text-lg md:text-xl font-medium">
              Product Image
            </label>
            <div>
              <label htmlFor="image">
